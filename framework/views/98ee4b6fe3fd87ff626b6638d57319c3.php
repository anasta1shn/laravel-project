...
<div class="l-navbar" id="nav-bar">
    <nav class="nav">
        <div>
            ...
            <div class="nav_list">
                <a href="<?php echo e(route('users.index')); ?>" class="nav_link" id="users">
                    <i class='bx bx-user nav_icon'></i>
                    <span class="nav_name">Пользователи</span>
                </a>
                <a href="<?php echo e(route('orders.index')); ?>" class="nav_link" id="orders">
                    <i class='bx bx-money-withdraw nav_icon'></i>
                    <span class="nav_name">Заказы</span>
                </a>
                <a href="<?php echo e(route('products.index')); ?>" class="nav_link" id="products">
                    <i class='bx bx-cart nav_icon'></i>
                    <span class="nav_name">Продукция</span>
                </a>
                <a href="<?php echo e(route('categories.index')); ?>" class="nav_link" id="categories">
                    <i class='bx bx-category nav_icon'></i>
                    <span class="nav_name">Категории</span>
                </a>
            </div>
        </div>
        <a href="<?php echo e(route('index')); ?>" class="nav_link">
...
<?php /**PATH /var/www/resources/views/admin/_panel.blade.php ENDPATH**/ ?>