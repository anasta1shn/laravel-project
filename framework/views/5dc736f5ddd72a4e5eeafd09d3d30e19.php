        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-3 ">
                <div class="cart-summary p-3 sidebar sticky-top-2">
                    ...
                    <div class="d-grid">
                        <a href="<?php echo e(route('checkout')); ?>" class="btn btn-primary">Перейти к оформлению заказа</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php if (! $__env->hasRenderedOnce('8ead592f-26b0-488a-9778-eda4f53e346c')): $__env->markAsRenderedOnce('8ead592f-26b0-488a-9778-eda4f53e346c');
                    ...
                    if (cart.length > 0) {
                        ...
                        $('.cart-inner').html(`
                            <div class="text-center">
                                ...
                                <a type="submit" class="btn btn-lg btn-primary mb-4 mt-4" href="<?php echo e(route('index')); ?>">
...
<?php echo $__env->make('layouts._layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/cart.blade.php ENDPATH**/ ?>
